...
INSERT INTO `countries` (`country_code`, `iso_code`, `country_name`, `currency_code`, `continent_code`, `population`, `are_in_sq_km`, `capital`) VALUES
	...
	('AX', 'ALA', '�?land', 'EUR', 'EU', 26711, 1580, 'Mariehamn'),
	...
	('BL', 'BLM', 'Saint Barthӊlemy', 'EUR', 'NA', 8450, 21, 'Gustavia'),
	...
	('BR', 'BRA', 'Brazil', 'BRL', 'SA', 201103330, 8511965, 'Brasӭlia'),
	...
	('CM', 'CMR', 'Cameroon', 'XAF', 'AF', 19294149, 475440, 'Yaoundӊ'),
	('CN', 'CHN', 'China', 'CNY', 'AS', 1330044000, 9596960, 'Beijing'),
	('CO', 'COL', 'Colombia', 'COP', 'SA', 47790000, 1138910, 'BogotӨ'),
	('CR', 'CRI', 'Costa Rica', 'CRC', 'NA', 4516220, 51100, 'San Josӊ'),
	...
	('EH', 'ESH', 'Western Sahara', 'MAD', 'AF', 273008, 266000, 'El Aai��n'),
	...
	('FO', 'FRO', 'Faroe Islands', 'DKK', 'EU', 48228, 1399, 'T��rshavn'),
	...
	('GU', 'GUM', 'Guam', 'USD', 'OC', 159358, 549, 'Hagӽt��a'),
	...
	('MV', 'MDV', 'Maldives', 'MVR', 'AS', 395650, 300, 'Malӊ'),
	...
	('PY', 'PRY', 'Paraguay', 'PYG', 'SA', 6375830, 406750, 'Asunci��n'),
	('QA', 'QAT', 'Qatar', 'QAR', 'AS', 840926, 11437, 'Doha'),
	('RE', 'REU', 'Rӊunion', 'EUR', 'AF', 776948, 2517, 'Saint-Denis'),
	...
	('ST', 'STP', 'SӁo Tomӊ and Prӭncipe', 'STD', 'AF', 175808, 1001, 'SӁo Tomӊ'),
	...
	('TF', 'ATF', 'French Southern Territories', 'EUR', 'AN', 140, 7829, 'Port-aux-Franӯais'),
	('TG', 'TGO', 'Togo', 'XOF', 'AF', 6587239, 56785, 'Lomӊ'),
...
INSERT INTO `currencies` (`currency_code`, `description`) VALUES
	...
	('STD', 'SӁo Tomӊ and Prӭncipe Dobra'),
	...
	('VUV', 'Vanuatu Vatu'),
	('WST', 'Samoa Tala'),
	('XAF', 'Communautӊ Financiӣre Africaine (BEAC) CFA Franc BEAC'),
	('XCD', 'East Caribbean Dollar'),
	('XDR', 'International Monetary Fund (IMF) Special Drawing Rights'),
	('XOF', 'Communautӊ Financiӣre Africaine (BCEAO) Franc'),
	('XPF', 'Comptoirs Franӯais du Pacifique (CFP) Franc'),
	('YER', 'Yemen Rial'),
...
INSERT INTO `rivers` (`id`, `river_name`, `length`, `drainage_area`, `average_discharge`, `outflow`) VALUES
	...
	(8, 'ParanӨ', 4880, 2582672, 18000, 'Rӭo de la Plata'),
	...
	(20, 'Pur��s', 3211, 63166, 8400, 'Amazon'),
	(21, 'Yukon', 3185, 850000, 6210, 'Bering Sea'),
	(22, 'Indus', 3180, 960000, 7160, 'Arabian Sea'),
	(23, 'SӁo Francisco', 3180, 610000, 3300, 'Atlantic Ocean'),
